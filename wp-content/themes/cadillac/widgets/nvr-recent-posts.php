...
class NVR_RecentPostWidget extends WP_Widget {
	...
	function NVR_RecentPostWidget() {
		$widget_ops = array('classname' => 'widget_nvr_lattest_posts', 'description' => __('Latest Posts',THE_LANG) );
		$this->WP_Widget('nvr-lattest-posts', __('Latest Posts',THE_LANG), $widget_ops);
	}

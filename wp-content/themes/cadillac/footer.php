 ...
 */
                ...
                <aside id="sidebar" class="four columns <?php if($nvr_pagelayout=="two-col-left"){echo "positionright";}else{echo "positionleft";}?>">
                    <?php get_sidebar();?>  
                </aside><!-- sidebar -->
        ...
        <div id="outerfootersidebar">
        	<div class="container">
                <div id="footersidebarcontainer" class="row"> 
                    ...
                    <div id="footcol<?php echo $nvr_numfootcol; ?>"  class="<?php echo $nvr_footclass[$i]; ?>">

<?php 
	...
	function nvr_row($atts, $content = null) {
		...
		$nvr_output = '<div class="row '.$class.'">' . $content . '</div>';
	...
	function nvr_one_half($atts, $content = null) {
		...
		$nvr_output = '<div class="six columns '.$class.'">' . $content . '</div>';
	...
	function nvr_one_third($atts, $content = null) {
		...
		$nvr_output = '<div class="four columns '.$class.'">' . $content . '</div>';
	...
	function nvr_one_fourth($atts, $content = null) {
		...
		$nvr_output = '<div class="three columns '.$class.'">' . $content . '</div>';
	...
	function nvr_one_sixth($atts, $content = null) {
		...
		$nvr_output = '<div class="two columns '.$class.'">' . $content . '</div>';
	...
	function nvr_two_third($atts, $content = null) {
		...
		$nvr_output = '<div class="eight columns '.$class.'">' . $content . '</div>';
	...
	function nvr_three_fourth($atts, $content = null) {
		...
		$nvr_output = '<div class="nine columns '.$class.'">' . $content . '</div>';
	...
	function nvr_five_sixth($atts, $content = null) {
		...
		$nvr_output = '<div class="ten columns '.$class.'">' . $content . '</div>';

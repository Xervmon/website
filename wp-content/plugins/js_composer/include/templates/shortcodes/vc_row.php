<?php
$output = $el_class = $bg_image = $bg_color = $bg_image_repeat = $font_color = $padding = $margin_top = $margin_bottom = $css = '';
...
$style = $this->buildStyle($bg_image, $bg_color, $bg_image_repeat, $font_color, $padding, $margin_bottom, $margin_top);
$strypestyle = '';
...
if($row_type=='section'){
	$style = $this->buildStyle('','','',$font_color, $padding);
	$strypestyle = $this->buildStyle($bg_image, $bg_color, $bg_image_repeat, '', '', $margin_bottom, $margin_top);
}
...
if($row_type=='section'){
	...
	$output = '<div '.$anchor_id.' class="stripecontainer '.$el_class.'"'.$strypestyle.'>'.$voutput.'<div class="stripewrapper">'.$output.'</div></div>';
}
